...
stack_sizes = (n_channels, )
R_stack_sizes = stack_sizes
A_filt_sizes = ()
Ahat_filt_sizes = (3,)
R_filt_sizes = (3, )
layer_loss_weights = np.array([1.])  # weighting for each layer in final loss; "L_0" model:  [1, 0, 0, 0], "L_all": [1, 0.1, 0.1, 0.1]
...
lr_schedule = lambda epoch: 0.001 if epoch < 1000 else 0.0001    # start with lr of 0.001 and then drop to 0.0001 after 1000 epochs
